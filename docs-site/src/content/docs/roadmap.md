...
encrypted single-file vault, per-recipient encryption, scoped agent access over
MCP, team management, and BIP39 recovery — is already in place. What 1.0 adds is
validation and stability guarantees. It ships when all of these hold:
